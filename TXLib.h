...
//=================================================================================================================
//           [These sections are for folding control  in Code::Blocks]         [$Date: 2023-09-05 19:24:34 +0400 $]
...
#define _TX_VER      _TX_v_FROM_CVS ($VersionInfo: , TXLib.h, 00173a, 172, 2023-09-05 19:24:34 +0400, "Ded (Ilya Dedinsky, http://txlib.ru) <mail@txlib.ru>", $)
#define _TX_VERSION  _TX_V_FROM_CVS ($VersionInfo: , TXLib.h, 00173a, 172, 2023-09-05 19:24:34 +0400, "Ded (Ilya Dedinsky, http://txlib.ru) <mail@txlib.ru>", $)
#define _TX_AUTHOR   _TX_A_FROM_CVS ($VersionInfo: , TXLib.h, 00173a, 172, 2023-09-05 19:24:34 +0400, "Ded (Ilya Dedinsky, http://txlib.ru) <mail@txlib.ru>", $)
...
$   CONSOLE_SCREEN_BUFFER_INFO con = {};
$   bool     redir   = (GetConsoleScreenBufferInfo (GetStdHandle (STD_OUTPUT_HANDLE), &con) == 0);
...
$   const wchar_t* xlat[33] = {L"\x25AF" /* 00 - NUL - NULL             */, L"\x263A" /* 01 - SOH - Start of header      */,
